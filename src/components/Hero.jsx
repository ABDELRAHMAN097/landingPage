    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="text-center w-full">
        <input
          ...
          className="border border-gray-300 rounded-l-md px-[5px] md:px-4 py-[4px] md:py-[9px] focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
        <button className="bg-teal-400 text-white px-[5px] md:px-4 py-[5px] md:py-[10.5px] rounded-r-md hover:bg-teal-500 transition">
          Notify Me
        </button>
      </div>
      </div>
